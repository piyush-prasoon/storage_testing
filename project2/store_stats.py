import os #used to  communicate adn obtain information from the OS
...
def get_device_details(device):
        ...
        try:
            ...
            partition_str = ",".join(partitions) if partitions else  "None" # listing the partitions in the from of a string 
            ...
            data = {
                "Device": device,
                "UUID" : str(uuid.uuid5(uuid.NAMESPACE_DNS, device)),
                "Time": timestamp,
                "Model": model,
